                ...
                <div class="col-9">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="d-grid gap-2">
                                    <button class="btn primary-btn btn-sm" v-on:click="changeDiscoverStatus()">
                                        <h4> Discover </h4>
                                    </button>
                                </div>
                            </div>
                        ...
                        <!-- [if] discovery not clicked -->
                        <div v-if="discovery == false" class="row">
                        ...
                        <div v-else>
                            <div v-for="listing in mostReviews" v-bind:key="listing._id" class="row p-3">
                                <img :src="'data:image/jpeg;base64,' + (listing['photo'] || defaultProfilePhoto)" alt="" class="profile-image-lg" style="display: inline-block;">
                            </div>
                        </div>
