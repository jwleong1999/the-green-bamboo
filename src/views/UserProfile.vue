                                ...
                                <div class="edit-drink-choice">
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div v-for="(drinkType, index) in drinkTypes" :key="index" class="m-1" style="display: inline-block">
                                                <input type="checkbox" class="btn-check" :id="index" autocomplete="off" v-model="selectedDrinks" :value="drinkType">
                                                <label class="btn btn-primary" :for="index">{{drinkType}}</label>
                                            </div>
                ...
                <div class="tab-content container mt-2">
                    ...
                    <div class="tab-pane fade show active" id="reviews">
                        ...
                        <div>
                            ...
                            <div class="image-container" v-for="(activity, index) in recentActivity" :key="index" >
                                <img :src=" 'data:image/png;base64,' + (photo || defaultDrinkImage)" alt="" class="rounded border border-dark-subtle border-2 bottle-img me-3">
                                <!-- svg for bookmarked -->
                                <svg v-if="bookmarkStatus[activity]" xmlns="http://www.w3.org/2000/svg" height="16" width="12" viewBox="0 0 384 512" class="icon">
                        ...
                        <div>
                            <div v-for="(review, index) in reviews" :key="index">
                                <div style="display: flex" class="mb-3" v-if="review.Username == user.Username">
    ...
    methods: {
        ...
        async loadData() {
            ...
            try {
                ...
                this.userBookmarks = this.user["Bookmark"];
                this.userBookmarks = {
                    "Drinks I Have Tried": ["Ube Cream Liqueur"],
            ...
            try {
                ...
                this.drinkTypes = this.drinkCategories.map(category => category["Drink Type"]);
