        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-8 col-md-10">
                ...
                <form>
                    ...
                    <div v-if="bottleNameOK" class="card my-5">
                        ...
                        <div class="card-body m-2 p-3">
                            <div class="row card-text text-start"> 
                                ...
                                <!-- <span class="fw-bold"> Bottle Name: </span> {{ bottleName }} <br>
                                <span class="fw-bold"> Menu Section: </span> {{ selectedMenuSection }}  -->
                    ...
                    <!-- [button] allow submit -->
                    <div>
                        <button type="submit" class="btn tertiary-btn rounded reverse-clickable-text" v-bind:disabled="!bottleNameOK || !menuSectionOK" v-on:click="addListingToMenu()"> 
                            Add Listing to Menu 
                        </button>
                    </div>
                </form>
