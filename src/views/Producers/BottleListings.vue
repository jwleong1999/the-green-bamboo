            ...
            <div class="col-9 no-margin">
                ...
                <div class="row pt-4">
                    ...
                    <div class="col-1 text-end">
                        <!-- bookmark icon -->
                        <svg v-if="checkBookmarkStatus(listing_id) && user" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bookmark-fill" viewBox="0 0 16 16"
                            data-bs-toggle="modal" data-bs-target="#bookmarkModal" @click="populateBookmarkModal(specified_listing._id)">
