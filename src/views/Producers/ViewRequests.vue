                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6 col-12 my-1 px-1" v-for="requestNew in requestListings" :key="requestNew._id">
                    <div class="card border-warning h-100">
                        ...
                        <div class="card-footer">
                            <router-link v-if="role == 'producer'" :to="{ path: '/Producer/Producer-Create-Listing/' + requestNew._id['$oid'] }">
                                <button class="border btn btn-warning btn-sm align-bottom">Open Request</button>
                            </router-link>
                            <router-link v-if="role == 'user'" :to="{ path: '/Users/request/new/' + requestNew._id['$oid'] }">
                                <button class="border btn btn-warning btn-sm align-bottom">Open Request</button>
                            </router-link>
                        </div>
                    </div>
            ...
            <div class="collapse row" id="collapseEdit">
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6 col-12 my-1 px-1" v-for="requestEdit in requestEdits" :key="requestEdit._id">
                    <div class="card border-secondary h-100">
                        ...
                        <div class="card-footer">
                            <router-link v-if="role == 'producer'" :to="{ path: '/Producer/Producer-Edit-Listing/' + requestEdit.listingID['$oid'] + '/' + requestEdit._id['$oid'] }">
                                <button class="border btn btn-secondary btn-sm align-bottom">Open Request</button>
                            </router-link>
                            <router-link v-if="role == 'user'" :to="{ path: '/Users/request/modify/edit/' + requestEdit.listingID['$oid'] + '/' + requestEdit._id['$oid'] }">
                                <button class="border btn btn-secondary btn-sm align-bottom">Open Request</button>
                            </router-link>
                        </div>
                    </div>
            ...
            <div class="collapse row" id="collapseDupe">
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6 col-12 my-1 px-1" v-for="requestDupe in requestDupes" :key="requestDupe._id">
                    <div class="card border-dark h-100">
                        ...
                        <div class="card-footer">
                            <router-link v-if="role == 'producer'" :to="{ path: '/Producer/Producer-Edit-Listing/' + requestDupe.listingID['$oid'] + '/' + requestDupe._id['$oid'] }">
                                <button class="border btn btn-dark btn-sm align-bottom">Open Request</button>
                            </router-link>
                            <router-link v-if="role == 'user'" :to="{ path: '/Users/request/modify/duplicate/' + requestDupe.listingID['$oid'] + '/' + requestDupe._id['$oid'] }">
                                <button class="border btn btn-dark btn-sm align-bottom">Open Request</button>
                            </router-link>
                        </div>
                    </div>
                    ...
                    try {
                        ...
                        if (this.role == 'producer') {
                            this.requestListings = response.data.filter((request) => {
                                return request["producerID"]["$oid"] == localStorage.getItem('88B_accID') && request["reviewStatus"] == false;
                            })
                        }
                        else if (this.role == 'user') {
                            this.requestListings = response.data.filter((request) => {
                                return request["userID"]["$oid"] == localStorage.getItem('88B_accID') && request["reviewStatus"] == false;
                            })
                        }
                    } 
                    catch (error) {
                    ...
                    try {
                        ...
                        if (this.role == 'producer') {
                            this.requestEdits = this.requestEdits.filter((request) => {
                                return request["producerID"]["$oid"] == localStorage.getItem('88B_accID');
                            })
                            ...
                            this.requestEdits = this.requestEdits.filter((request) => {
                                return request["userID"]["$oid"] == localStorage.getItem('88B_accID');
                            })
                            this.requestDupes = this.requestDupes.filter((request) => {
                                return request["userID"]["$oid"] == localStorage.getItem('88B_accID');
                            })
