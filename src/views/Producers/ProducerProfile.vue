                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="datetime"> Date </span>
                                                <input type="text" class="form-control" :value="formatDate(currDate)" aria-label="Date" aria-describedby="datetime" disabled>
                                            </div>
                                            <!-- text -->
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="text"> Text </span>
                                                <textarea type="text" class="form-control" aria-label="Date" aria-describedby="text" rows="5"></textarea>
                                            </div>
                                            <!-- image -->
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="photo"> Photo </span>
                                                <input id="photo" type="file" v-on:change="file" ref="fileInput" >
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn primary-square"> Save changes </button>
                                        </div>
                                    </div>
                                </div>
                            </div>
