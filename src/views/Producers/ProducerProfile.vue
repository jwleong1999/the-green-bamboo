                    ...
                    <div class="col-12">
                        <div class="square primary-square rounded p-3 mb-3">
                            ...
                            <div class="text-start pt-2">
                                <!-- responses to q&a -->
                                <!-- [TODO] replace with actual qns and answers -->
                                <div>
                                    <p> <b> Q: Have you ever considered using a port wine cask? </b> </p> 
                                    <p> A: Yes we have! We actually had a Ardbeg Baaaa edition that uses port wine cask to give the whisky a more fruity finish. </p>
                                </div>
                                <!-- ask questions -->
                                <div class="input-group centered">
