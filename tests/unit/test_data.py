...
class TestData(unittest.TestCase):
    ...
    def test_flavourTags(self):
        ...
        hexcode = "#FF0000"
        flavour_tag = flavourTags(hexcode=hexcode, familyTag="Fruity", subtag=["Apple", "Strawberry"])
        self.assertEqual(flavour_tag.hexcode, hexcode)

    
        # Test case 2: Check if the familyTag is set correctly
        family_tag = "Fruity"
        flavour_tag = flavourTags(hexcode="#FF0000", familyTag=family_tag, subtag=["Apple", "Strawberry"])
        self.assertEqual(flavour_tag.familyTag, family_tag)

    
        # Test case 3: Check if the subtag is set correctly
        subtag = ["Apple", "Strawberry"]
        flavour_tag = flavourTags(hexcode="#FF0000", familyTag="Fruity", subtag=subtag)
        self.assertEqual(flavour_tag.subtag, subtag)
